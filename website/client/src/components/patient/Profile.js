            ...
            <div className="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
              <div className="d-flex">
                <div className="breadcrumb">
                  ...
                  <a href="user_pages_profile.html" className="breadcrumb-item">
                    User pages
                  </a>
              ...
              <div className="header-elements d-none">
                <div className="breadcrumb justify-content-center"></div>
              </div>
            </div>
          </div>
          {/* /page header */}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            ...
                            <input
                              type="text"
                              readOnly="readonly"
                              defaultValue="kanishkgupta2000@gmail.com"
                              className="form-control"
                            />
                          </div>
                        </div>
                      ...
                      <div className="card-img-actions d-inline-block mb-3">
                        ...
                        <div className="card-img-actions-overlay card-img rounded-circle">
                          ...
                          <a
                            ...
                            className="btn btn-outline bg-white text-white border-white border-2 btn-icon rounded-round ml-2"
                          >
