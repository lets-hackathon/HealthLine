            ...
            <ul className="nav nav-sidebar" data-nav-type="accordion">
              ...
              <li className="nav-item nav-item-submenu">
                ...
                <ul className="nav nav-group-sub" data-submenu-title="Layouts">
                  ...
                  <li className="nav-item">
                    <a
                      href="http://demo.interface.club/limitless/demo/bs4/Template/layout_2/LTR/default/full/index.html"
                      className="nav-link"
                    >
                      Show My Reminders
                    </a>
              ...
              <li className="nav-item nav-item-submenu">
                <a href="#" className="nav-link">
                  <i className="icon-color-sampler" /> <span>My Records</span>
                </a>
                <ul className="nav nav-group-sub" data-submenu-title="Themes">
                  ...
                  <li className="nav-item">
                    <a
                      href="http://demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/material/full/index.html"
                      className="nav-link"
                    >
