    ...
    <Fragment>
      <div className="navbar navbar-expand-md navbar-dark">
        ...
        <div className="collapse navbar-collapse" id="navbar-mobile">
                  ...
                  <ul className="media-list">
                    <li className="media">
                      <div className="mr-3">
                        <a
                          href="#"
                          className="btn bg-transparent border-primary text-primary rounded-round border-2 btn-icon"
                        >
                    ...
                    <li className="media">
                      <div className="mr-3">
                        <a
                          href="#"
                          className="btn bg-transparent border-warning text-warning rounded-round border-2 btn-icon"
                        >
                    ...
                    <li className="media">
                      <div className="mr-3">
                        <a
                          href="#"
                          className="btn bg-transparent border-info text-info rounded-round border-2 btn-icon"
                        >
                    ...
                    <li className="media">
                      ...
                      <div className="media-body">
                        ...
                        <span className="font-weight-semibold">Master</span> and{" "}
                        <span className="font-weight-semibold">Dev</span>{" "}
                        branches
                        <div className="text-muted font-size-sm">
                          Dec 18, 18:36
                        </div>
          ...
          <span className="badge  bg-success ml-md-3 mr-md-auto">Patient</span>
                ...
                <div className="dropdown-content-body dropdown-scrollable">
                  <ul className="media-list">
                    <li className="media">
                      <div className="mr-3">
                        <img
                          src=" global_assets/images/demo/users/face18.jpg"
                          width={36}
                          height={36}
                    ...
                    <li className="media">
                      ...
                      <div className="ml-3 align-self-center">
                        <span className="badge badge-mark border-danger" />
                      </div>
                    </li>
                    <li className="media">
                      <div className="mr-3">
                        <img
                          src=" global_assets/images/demo/users/face17.jpg"
                          width={36}
                          height={36}
                          className="rounded-circle"
                          alt=""
                    ...
                    <li className="media">
                      <div className="mr-3">
                        <img
                          src=" global_assets/images/demo/users/face19.jpg"
                          width={36}
                          height={36}
                          className="rounded-circle"
                          alt=""
                      ...
                      <div className="ml-3 align-self-center">
                        <span className="badge badge-mark border-warning-300" />
                      </div>
                    </li>
                    <li className="media">
                      <div className="mr-3">
                        <img
                          src=" global_assets/images/demo/users/face16.jpg"
                          width={36}
                          height={36}
                          className="rounded-circle"
                          alt=""
                      ...
                      <div className="ml-3 align-self-center">
                        <span className="badge badge-mark border-grey-400" />
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div className="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
                ...
                <div className="dropdown-content-footer justify-content-center p-0">
                  <a
                    ...
                    title="Load more"
                  >
                    <i className="icon-menu7 d-block top-0" />
                  </a>
                </div>
              </div>
            </li> */}
