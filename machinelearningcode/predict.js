const tf = require('@tensorflow/tfjs-node'); //if fails comment line 1 and uncomment line 2
//const tf = require('@tensorflow/tfjs);
const label2id = require('./label2id.json')
const word2id = require('./word2id.json')

//const cors = require('cors');
//const express = require("express");
//const app = express();
const data = require("./narendramoditweets.json"); //sample data
